/*
 * Smart Microondas - ESP32 BLE Minimal Prototype
 * Simple BLE connection for app communication
 */
 ...
 #define CHAR_UUID_RX        0xFF01  // Receive commands from app
 #define CHAR_UUID_TX        0xFF02  // Send data to app
 ...
 static void gatts_event_handler(esp_gatts_cb_event_t event, esp_gatt_if_t gatts_if, 
     ...
     case ESP_GATTS_CREAT_ATTR_TAB_EVT:
         if (param->add_attr_tab.status == ESP_GATT_OK) {
             ESP_LOGI(TAG, "Attribute table created with %d handles", param->add_attr_tab.num_handle);
 ...
 void app_main(void) {
     ...
     ESP_LOGI(TAG, "⏳ Waiting for app connection...");
 }